...
def test_packages_importable():
    ...
    assert importlib.import_module('plotting.temperature_dependence.core')
    assert importlib.import_module('plotting.temperature_sensitivity.core')
    assert importlib.import_module('plotting.stress_dependence.core')
    assert importlib.import_module('plotting.stress_sensitivity.core')
    assert importlib.import_module('plotting.current_annealing.core')
    assert importlib.import_module('plotting.vsm_hysteresis_loops')
