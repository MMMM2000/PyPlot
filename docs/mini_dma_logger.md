...
- TMA exposes the Tic motor winding current limit separately from the HMP motor-supply rail limit; recipe preflight applies the Tic limit and blocks recipe start if that controller setting cannot be applied
