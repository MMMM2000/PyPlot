...
- HMP4030/HMP4040 users can assign the motor-supply and current-sweep channels independently; the current HMP4040 bench defaults to CH3 at 12 V / 0.5 A for motor power and CH4 for current annealing, recipe preflight turns the motor channel on before checking Tic VIN, and the current-sweep voltage limit defaults to 32.05 V
