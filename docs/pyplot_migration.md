...
- `plotting/*/*_gui.py` – removal in progress; high-traffic dialogs have been folded into the plugin packages, with the remaining embedded widgets slated for migration.
