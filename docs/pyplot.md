...
| Current Annealing       | `plotting.plugins.current_annealing`                  | Splits batches by annealing direction and now uses shared PyPlot Origin export/workbook handling (same shared title placement and axis-label behavior used by other shared-export plugins). |
