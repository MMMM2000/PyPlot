...
- `kosice_kern_first_overheating`: 2026-07-02 Kosice mounted-wire profile for the KERN TEWJ 600-2M/B balance. It uses 36.931 mm length, 18.2 um diameter, `16.5 Hz` feedback cadence, `0.085 s` scale latency, and 0.01 g quantized raw scale feedback.
