...
- `kosice_kern_first_overheating`: 2026-07-02 Kosice mounted-wire profile for the KERN TEWJ 600-2M/B balance. It uses about 37.0 mm length, 18.2 um diameter, `20 Hz` feedback cadence, `0.05 s` scale feedback interval, 0.01 g quantized raw scale feedback, and an explicit controller-wait model for post-hold feedback/correction overhead.
