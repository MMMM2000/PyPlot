...
- Complete each elastocaloric pull or release after its one confirmed displacement command and record window, preventing the relative jump from accumulating on later controller ticks.
