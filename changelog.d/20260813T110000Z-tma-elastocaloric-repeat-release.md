...
- Reflowed the elastocaloric recipe controls and replaced cloud-folder browsing with direct path entry, avoiding synchronous DriveFS enumeration and folder-selection freezes during remote moves or synchronization.
