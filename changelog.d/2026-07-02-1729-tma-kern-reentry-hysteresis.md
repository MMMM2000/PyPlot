...
- Calibrated the Kosice KERN TMA simulator profile to the observed 50 ms app poll setting, approximately 16 Hz full-session raw scale cadence, 0.01 g quantized readback, mounted-wire geometry, and controller wait overhead from the 2026-07-02 run.
