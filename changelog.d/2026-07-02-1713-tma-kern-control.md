...
- Added conservative fast-feedback KERN hold caps (`0.08%` base, response-earned `1.25x` adaptive ceiling, or `0.10%` strain) so the higher sample cadence does not compound quantized feedback into unstable motor corrections.
