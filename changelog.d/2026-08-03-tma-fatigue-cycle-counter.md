...
- Improve TMA run-summary plots with shared normal-sweep stress colors for strain and resistance, explicit increasing/decreasing-current symbols, selected-current stress-strain curves, adaptive time units, control-tolerance context, and first-overheating exclusion from comparison panels.
