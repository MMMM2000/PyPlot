...
- Mini DMA current sweeps now advance current from elapsed time and HMP4030-style 1 mA setpoint resolution, reducing serial command churn and avoiding fake sub-mA current steps that the supply cannot reliably apply.
