...
- Mini DMA updates the HMP4030 current-sweep voltage limit to 32.05 V and defaults the copied-bench motor supply to CH2 at 12 V / 0.4 A while keeping current annealing on CH3.
